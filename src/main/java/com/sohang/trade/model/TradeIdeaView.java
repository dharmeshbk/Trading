...
public class TradeIdeaView {
	...
	public TradeIdeaView(TradeIdea tradeIdea, float accountBalance,float maxOpenPosition) {
	...
	public float getTotalAmount() {
		...
		return Utils.roundTo2Decimal(totalAmount);
	}

	public float getTotalriskAmount() {
		totalriskAmount = getRiskAmount() * actualQty;
		return Utils.roundTo2Decimal(totalriskAmount);
	}
	...
	public float getProbability() {
		...
		return Utils.roundTo2Decimal(probability);
	}
	...
	public String toString() {
		return "TradeIdeaView [ticker=" + ticker + ", watchDate=" + watchDate
